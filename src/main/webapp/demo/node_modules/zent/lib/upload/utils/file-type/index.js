...
var toBytes = function toBytes(s) {
  return (0, _toArray2['default'])(s).map(function (c) {
...
module.exports = function (input) {
  ...
  if (check([0x50, 0x4b, 0x3, 0x4])) {
    ...
    if (check(oxmlContentTypes, {
      ...
      var nextZipHeaderIndex = function nextZipHeaderIndex(arr) {
        return (0, _findIndex2['default'])(arr, function (el, i, arr) {
  ...
  if (check([0x1a, 0x45, 0xdf, 0xa3])) {
    ...
    var idPos = (0, _findIndex2['default'])(_sliced, function (el, i, arr) {
    ...
    if (idPos !== -1) {
      ...
      var findDocType = function findDocType(type) {
        return (0, _toArray2['default'])(type).every(function (c, i) {
