...
var SecondPanel = function (_ref) {
  (0, _inherits3['default'])(SecondPanel, _ref);

  function SecondPanel() {
    (0, _classCallCheck3['default'])(this, SecondPanel);
    return (0, _possibleConstructorReturn3['default'])(this, (SecondPanel.__proto__ || Object.getPrototypeOf(SecondPanel)).apply(this, arguments));
  }

  (0, _createClass3['default'])(SecondPanel, [{
    key: 'isSelected',
    ...
    value: function isCurrent(val) {
      return _utils.CURRENT.getSeconds() === val;
    }
  }, {
    key: 'getSeconds',
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          'div',
          { className: 'second-table panel-table' },
          _react2['default'].createElement(_TimeCell2['default'], { cells: seconds, onSelect: onSelect })
        )
      );
    }
  }]);
