...
.zent-badge.zent-badge-none-cont {
  font-size: 0;
}
.zent-badge.zent-badge-none-cont .zent-badge-count {
      position: relative;
...
.zent-datetime-picker-popover .range-picker--showTime .date-picker .time-panel .hour-panel, .zent-datetime-picker-popover .range-picker--showTime .date-picker .time-panel .minute-panel, .zent-datetime-picker-popover .range-picker--showTime .date-picker .time-panel .second-panel {
              height: 265px;
            }
...
.zent-datetime-picker-popover .time-panel .hour-panel, .zent-datetime-picker-popover .time-panel .minute-panel, .zent-datetime-picker-popover .time-panel .second-panel {
        position: absolute;
        top: 0;
        left: 0;
        height: 327px;
...
@font-face {
  ...
  src: url('https://b.yzcdn.cn/zent/zenticon/zenticon-5cc342dd45.eot');
  src: url('https://b.yzcdn.cn/zent/zenticon/zenticon-5cc342dd45.eot?#iefix') format('embedded-opentype'),
      url('https://b.yzcdn.cn/zent/zenticon/zenticon-5cc342dd45.woff2') format('woff2'),
      url('https://b.yzcdn.cn/zent/zenticon/zenticon-5cc342dd45.woff') format('woff'),
      url('https://b.yzcdn.cn/zent/zenticon/zenticon-5cc342dd45.ttf') format('truetype')
}
.zenticon {
    display: inline-block;
    speak: none;
...
.zent-infinite-scroller .zent-loading-container {
...
.zent-menu .zent-menu-item.zent-submenu:hover {
  background-color: #fff;
  color: #666;
}
...
.zent-sku .zent-sku-item .item-remove.small {
  top: -8px;
  right: -8px;
  width: 18px;
  height: 18px;
...
.zent-upload-network-image-region, .zent-upload-local-attachment-region {
  padding: 30px 10px;
  overflow: hidden;
}
.zent-upload-network-image-region .zent-upload-title, .zent-upload-local-attachment-region .zent-upload-title {
    float: left;
    font-size: 14px;
    font-weight: bold;
    text-align: right;
  }
.zent-upload-network-image-region .zent-upload-content, .zent-upload-local-attachment-region .zent-upload-content {
    background-color: #fff;
    position: relative;
    zoom: 1;
    margin-left: 80px;
...
.zent-upload-local-attachment-region .upload-local-image-list {
    height: auto;
    padding-top: 10px;
  }
.zent-upload-local-attachment-region .image-list .upload-local-image-item {
      position: relative;
      float: left;
...
.zent-upload-local-attachment-region .image-list .upload-local-image-item:hover .close-modal {
          display: block;
}
.zent-upload-local-attachment-region .image-list .image-box {
      width: 80px;
      height: 80px;
      background-size: cover;
      background-position: 50% 50%;
    }
.zent-upload-local-attachment-region .image-list .image-progress {
      position: absolute;
      top: 0;
      left: 0;
      bottom: 0;
...
.zent-upload-local-attachment-region .voice-list {
    margin-left: -10px;
    height: auto
  }
.zent-upload-local-attachment-region .voice-list::after {
  content: ".";
  display: block;
  height: 0;
  clear: both;
...
.zent-upload-local-attachment-region .voice-list .voice-item {
      position: relative;
      float: left;
      width: 300px;
      height: 60px;
...
.zent-upload-local-attachment-region .voice-list .voice-item:hover .close-modal {
          display: block;
}
.zent-upload-local-attachment-region .voice-list .voice-icon {
      width: 40px;
      height: 40px;
      background: #cacaca;
...
.zent-upload-local-attachment-region .voice-list .voice-icon.loading {
  background-image: url('https://b.yzcdn.cn/upload/image/loading@2x.gif');
}
.zent-upload-local-attachment-region .voice-list .voice-icon.playing {
  background-image: url('https://b.yzcdn.cn/upload/image/playing@2x.gif');
}
.zent-upload-local-attachment-region .voice-list .voice-name {
      position: absolute;
      width: 200px;
      height: 18px;
      line-height: 18px;
...
.zent-upload-local-attachment-region .voice-list .voice-createtime {
      position: absolute;
      top: 34px;
      left: 60px;
      color: #999;
}
.zent-upload-local-attachment-region .voice-list .voice-duration {
      position: absolute;
      top: 12px;
      right: 10px;
}
.zent-upload-local-attachment-region .voice-list .voice-size {
      position: absolute;
      top: 34px;
      right: 10px;
      color: #999;
}
.zent-upload-local-attachment-region .close-modal {
    display: none;
    position: absolute;
    z-index: 2;
    top: -9px;
...
.zent-upload-local-attachment-region .close-modal.small {
  top: -8px;
  right: -8px;
  width: 18px;
  height: 18px;
...
.zent-upload-local-attachment-region .close-modal.small:hover {
  color: #fff;
  background: #333;
}
