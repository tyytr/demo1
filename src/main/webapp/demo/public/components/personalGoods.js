...
import {personGoodsDisagree} from "../actions/auth";

class PersonalGoods extends Component{
    constructor(props) {
        super(props);
        this.state = {
            tabPosition: 'left',
    ...
    componentDidMount(){
        ...
        axios.get(`${ROOT_URL}/person/showGoods?id=${id}`)
            .then(response =>{
                ...
                <div style={{ marginBottom: 16 }}>
                    <Button
                        ...
                        onClick={() => {
                            ...
                            personGoodsDisagree(selectedRowKeys);
                            setTimeout(() => {
                                this.setState({
                                    selectedRowKeys: [],
                                    loadingDisagree: false,
